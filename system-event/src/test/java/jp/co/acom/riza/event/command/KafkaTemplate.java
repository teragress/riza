...
public class KafkaTemplate<K, V> implements KafkaOperations<K, V> {
	...
	private static List<ProducerRecord<Object, Object>> saveList = new ArrayList<>();
	...
	public List<ProducerRecord<Object,Object>> getSaveList() {
		return saveList;
	}
	/**
	...
	protected ListenableFuture<SendResult<K, V>> doSend(final ProducerRecord<K, V> producerRecord) {
		saveList.add((ProducerRecord<Object, Object>)producerRecord);
		if (true) return null;
